...
IFontDisp = Font
__all__ = [ 'VgaColor', 'FONTNAME', 'OLE_XPOS_CONTAINER',
           'OLE_TRISTATE', 'OLE_XSIZE_CONTAINER', 'FONTBOLD', 'Font',
           'IFontEventsDisp', 'OLE_YSIZE_CONTAINER',
           'FONTSTRIKETHROUGH', 'OLE_YSIZE_HIMETRIC', 'IFontDisp',
           'Checked', 'OLE_ENABLEDEFAULTBOOL', 'StdPicture',
           'OLE_YPOS_CONTAINER', 'OLE_XSIZE_PIXELS', 'Picture',
           'OLE_YPOS_PIXELS', 'OLE_CANCELBOOL', 'Monochrome',
           'FontEvents', 'IFont', 'FONTSIZE', 'OLE_XSIZE_HIMETRIC',
           'LoadPictureConstants', 'IPicture', 'Gray', 'Default',
           'IPictureDisp', 'OLE_OPTEXCLUSIVE', 'OLE_HANDLE',
           'OLE_YPOS_HIMETRIC', 'FONTITALIC', 'Unchecked',
           'OLE_XPOS_HIMETRIC', 'OLE_YSIZE_PIXELS', 'OLE_COLOR',
           'StdFont', 'FONTUNDERSCORE', 'Color', 'OLE_XPOS_PIXELS']
